    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">"Para subir documento Excel"</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          "No se puede mostrar previsualización del Excel, Una vez escrito</br>
          el nombre y seleccionado el Excel, haga click en 'Guardar Excel'</br>
          el documento se guardara en 'Lista Excel'"</br>
